...
impl Database {
    ...
    /// Delete all [`L1Message`]s with a block number greater than the provided block number.
    ...
    pub async fn get_l1_messages(
        ...
        impl DatabaseEntryStream<models::l1_message::Model, StreamItem = L1Message> + '_,
        DbErr,
    > {
