...
mod m20250408_132123_add_extra_data_table;
mod m20250408_150338_seed_extra_data_table;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20250408_132123_add_extra_data_table::Migration),
            Box::new(m20250408_150338_seed_extra_data_table::Migration),
        ]
    }
}
